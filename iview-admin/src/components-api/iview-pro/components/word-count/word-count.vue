<template>
    <div class="ivu-word-count">
        ...
        <template v-else>
            ...
            <span class="ivu-word-count-prefix ivu-word-count-overflow" v-else><slot
                    name="prefix-overflow"></slot></span>
            ...
            <template v-if="!hideTotal">
                ...
                <slot name="total" :total="total">{{ total }}</slot>
            </template>
            <span class="ivu-word-count-suffix" v-if="!isOverflow"><slot name="suffix"></slot></span>
            <span class="ivu-word-count-suffix ivu-word-count-overflow" v-else><slot
                    name="suffix-overflow"></slot></span>
        </template>
    </div>
</template>
<script>
