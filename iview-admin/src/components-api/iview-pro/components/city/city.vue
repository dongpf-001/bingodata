<template>
    <div class="ivu-city" :class="classes" ref="city">
        <Dropdown trigger="custom" :visible="visible" :transfer="transfer" placement="bottom-start"
                  transfer-class-name="ivu-city-transfer" @on-visible-change="handleVisibleChange"
                  @on-clickoutside="handleClickOutside">
            <div class="ivu-city-rel" @click="handleToggleOpen">
                <input type="hidden" :name="name" :value="currentValue">
                <slot>
                    <span>{{ codeToName }}</span>
                    <Icon type="ios-close-circle" class="ivu-city-arrow" v-show="showCloseIcon"
                ...
                <div class="ivu-city-drop">
                    ...
                    <div class="ivu-city-drop-menu">
                        ...
                        <div class="ivu-city-drop-search">
                            <i-select v-model="queryCity" filterable size="small" transfer
                                      :placeholder="searchPlaceholder" @on-change="handleSelect">
                                <i-option v-for="item in allCities" :value="item.c" :key="item.c">{{ item.n }}
                                </i-option>
                            </i-select>
                        </div>
                    </div>
                    <div class="ivu-city-drop-list" v-if="listType === 'province'">
                        <div class="ivu-city-drop-list-letter">
                            <Tag @click.native="handleClickLetter(item.n)" type="border" :fade="false"
                                 v-for="item in provinceList" :key="item.n">{{ item.n }}
                            </Tag>
                        </div>
                    ...
                    <div class="ivu-city-drop-list" v-if="listType === 'city'">
                        <div class="ivu-city-drop-list-letter">
                            <Tag @click.native="handleClickLetter(key)" type="border" :fade="false"
                                 v-for="(item, key) in cityListByLetter" :key="key">{{ key }}
                            </Tag>
                        </div>
