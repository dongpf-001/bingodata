<template>
    <div class="ivu-notifications" ref="notice">
        <Dropdown trigger="custom" :visible="visible" :transfer="transfer" :placement="placement"
                  transfer-class-name="ivu-notifications-transfer" @on-visible-change="handleVisibleChange"
            ...
            <DropdownMenu slot="list" v-if="$slots.default">
                <div class="ivu-notifications-list" :class="{ 'ivu-notifications-list-wide': wide }">
                    <div class="ivu-notifications-tabs">
                        <Tabs :animated="false" :value="tab" @on-click="handleTabChange">
                            <slot></slot>
                        </Tabs>
                    </div>
                </div>
                <div class="ivu-notifications-extra" v-if="$slots.extra">
