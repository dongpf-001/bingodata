        ...
        <slot>
            <row v-bind="rowProps">
                <i-col span="4" class="ivu-notifications-item-icon">
                    ...
                    <Avatar v-else-if="customIcon" :custom-icon="customIcon" :shape="avatarShape" :size="iconSize"
                            :style="iconStyle"/>
                ...
                <i-col :span="contentSpan" class="ivu-notifications-item-content">
                    ...
                    <div class="ivu-notifications-item-desc" v-if="content || $slots.content">
                        <slot name="content">{{ content }}</slot>
                    </div>
                    <div class="ivu-notifications-item-time" v-if="time || $slots.time">
                        <slot name="time">
                            <Time :time="time" v-bind="timeProps"/>
                        </slot>
                    </div>
                </i-col>
            </row>
