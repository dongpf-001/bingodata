        ...
        <div class="ivu-notifications-container" @scroll="handleScroll" ref="scroll">
            ...
            <div class="ivu-notifications-tab-loading">
                <div class="ivu-notifications-tab-loading-item ivu-notifications-tab-loading-show" v-if="loading">
                    <slot name="loading">
                        <Icon type="ios-loading" class="ivu-load-loop"/>
                        {{ NotificationInstance.locale.loading }}
                    </slot>
                </div>
                <div class="ivu-notifications-tab-loading-item ivu-notifications-tab-loading-more"
                     v-else-if="!loadedAll" @click="handleLoadMore">
                    <slot name="load-more">{{ NotificationInstance.locale.loadMore }}</slot>
                </div>
                <div class="ivu-notifications-tab-loading-item ivu-notifications-tab-loading-all"
                     v-else-if="showLoadedAll && loadedAll">
