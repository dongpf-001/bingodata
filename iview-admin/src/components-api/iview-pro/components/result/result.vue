<template>
    <div class="ivu-result">
        ...
        <div class="ivu-result-title" v-if="title || $slots.title">
            <slot name="title">{{ title }}</slot>
        </div>
        <div class="ivu-result-desc" v-if="desc || $slots.desc">
            <slot name="desc">{{ desc }}</slot>
        </div>
        <div class="ivu-result-extra" v-if="extra || $slots.extra">
            <slot name="extra">{{ extra }}</slot>
        </div>
        <div class="ivu-result-actions" v-if="$slots.actions">
