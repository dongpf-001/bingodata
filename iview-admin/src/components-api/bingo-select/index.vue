    ...
    <div>
        ...
        <Select v-model="model"
            ...
            <Option disabled value="" key="" style="color: white" v-if="showSelectAll && $attrs.multiple">
                ...
                <Button type='primary' size="small" style="float: right;margin-right: 6px" @click="selectAll">全选
                </Button>
            </Option>
            <Option :value="item.value" v-for="item in data" :key="item.value" v-show="!item.hiddenOption"
                    :disabled="item.disabledOption">{{item.label}}
            </Option>
        </Select>
        <!--下拉选择树-->
