<template>
    <div class="ivu-inline upload-wrapper">
        <div v-if="types=='picture'" style="float: left">
            <div class="bingo-upload-list" v-for="item in uploadList" :style="'width:'+pictureSize+'px;height:'+pictureSize+'px'">
        ...
        >
            ...
            <div style="position: relative">
                ...
                <div v-if="!(widths==100) && !multiple && types=='button'" class="progress-flot" ref="progress" :style="'width:' + widths + '%'">
                ...
                <!--上传图片-->
                <div :class="disabled ? 'upload-picture' : ''" :style="'width:'+pictureSize+'px;height:'+pictureSize+'px;line-height:'+pictureSize+'px'" v-if="types=='picture'">
        ...
        <div v-if="types=='modal'">
            ...
            <bingo-modal ref="modal"
                ...
                <Upload ref="upload" :action="action" :headers="headers" :multiple="multiple" :data="data" :name="name"
                        ...
                        :accept="accept" :format="format" :max-size="maxSize" :before-upload="beforeUpload" :on-progress="handleProgress"
                        :on-success="onSuccess" :on-error="onError" :on-preview="onPreview" :on-remove="onRemove"
                        :on-format-error="onFormatError" :on-exceeded-size="onExceededSize" :default-file-list="defaultFileList">
