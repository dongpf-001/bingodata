<template>
    <div class="query-box-wrapper">
        <div class="query-box query-box-form" :type="type">
            <Form class="query" :model="data" ref="form" :rules="rules" :label-width="labelW"
                  :label-position="labelPosition" @submit.native.prevent="handleSubmit">
                ...
                <Grid v-if="type != 'float'" :col="col" :border="false" justify="end" padding="2px">
                    <div class="query-wrapper">
                        <slot></slot>
                        <bingo-modal-form ref="modal" :col="col" :title="$t('page.common.search')" :width="width"
                                          :button="false"
                                          :labelWidth="labelWidth" :showDefault="false">
                            <slot></slot>
                            <div slot="footer-button">
                                <Button type="primary" html-type="submit" @click="handleSubmit">
