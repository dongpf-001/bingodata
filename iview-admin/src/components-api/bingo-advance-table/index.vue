<template>
    <div class="i-table-border list-page-out list-resize bingo-advance"  :style="'height:'+ 'calc(100% - '+sHeight+'px)' " ref="table-list" v-resize="handleResize" :class="{'fullScreen': fullFlag}">
        <div v-show="toolbar" ref="toolbar">
            <bingo-toolbar :showNew="showNew" :showDelete="showDelete" :showRefresh="showRefresh" :showOpenButton="showOpenButton"
