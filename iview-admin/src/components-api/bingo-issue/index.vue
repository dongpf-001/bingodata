<template>
    <div class="bingo-issue-wrapper">
        <Dropdown trigger="click" transfer @on-visible-change="visibleClick" transfer-class-name="bingo-issue-wrapper-drop">
            ...
            <DropdownMenu slot="list">
                <div class="issue-list-div">
                    ...
                    <div class="issue-list-div-body i-scrollbar">
                        <div class="issue-list-content" v-for="(item, key) in issueList" :key="key" @click="editClick(item)">
                            <span class="issue-lamp" :style="{background: (item.status==1?'#8e8f90':'#84bd00')}"></span>
                            <Icon type="ios-arrow-forward" style="float: right;margin-top: 4px;" @click="editClick(item)"/>
