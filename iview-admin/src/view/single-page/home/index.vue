    ...
    <Row>
        <i-col :span="widths>1440?17:widths>786 && widths<=1440?15:24" class="home-body-left" v-if="flag==1">
                ...
                <i-col :span="widths>1440 ? 8 : 24">
                    <Row :gutter="16">
                        <i-col :span="widths>1440 ? 24 : 12">
                            <index-card :widths="widths" :data="taskStatistical"
                                        :styles="{height: (widths>1440?140:180) + 'px'}">
                            </index-card>
                        </i-col>
                        <i-col :span="widths>1440 ? 24 : 12">
                            <index-card :widths="widths" :data="performStatistical"
                                        :styles="{height: (widths>1440?140:180) + 'px','margin-top': (widths>1440?16:0) + 'px'}">
                            </index-card>
                        </i-col>
                    </Row>
                </i-col>
            ...
            <Row :gutter="16">  <!-- 详细任务区域 -->
                <i-col span="24">
                    <index-task :span="widths>1440 ? 8 : 24" :widths="widths" :taskContext="taskContext"
                                :topHeight="topHeight"></index-task>
                </i-col>
            </Row>
            <!-- 786下显示 -->
            <index-footer :widths="widths"></index-footer>
        </i-col> <!-- 普通员工 -->
        <i-col :span="widths>1440?7:widths>786 && widths<=1440?9:24" class="home-body-right"
               v-if="flag==1 && widths>786"> <!-- user/参与的项目/推荐 -->
        ...
        <i-col :span="widths>1440?17:widths>786 && widths<=1440?15:24" class="home-body-left" v-if="flag==2">
            <Row :gutter="16"> <!-- 卡片区域 -->
                ...
                <i-col :span="widths>1440 ? 8 : 24">
                    <index-card3 :widths="widths" :data="systemNotice"
                                 :style="{'margin-top': (widths>1440?0:16) + 'px'}">
                    </index-card3>
                </i-col>
                <i-col :span="widths>1440 ? 8 : 24">
                    <index-card3 :widths="widths" :data="reportNumber"
                                 :style="{'margin-top': (widths>1440?0:16) + 'px'}">
                    </index-card3>
                </i-col>
            </Row>
        ...
        <i-col :span="widths>1440?17:widths>786 && widths<=1440?15:24" class="home-body-left" v-if="flag==3">
            <Row :gutter="16">
                ...
                <i-col :span="widths>1440 ? 8 : 24">
                    <index-card3 :widths="widths" :data="performStatistical"
                                 :style="{'margin-top': (widths>1440?0:16) + 'px'}">
                    </index-card3>
                </i-col>
