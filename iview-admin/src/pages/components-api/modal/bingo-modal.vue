            ...
            <div class="demo-split" style="height: 450px">
                <Split v-model="split" mode="vertical">
                    <div slot="top" class="demo-split-pane">
                        ...
                        <bingo-modal ref="modal1" v-model="showModel.modal1Show" :title="model.title"
                        ...
                        <bingo-modal ref="modal2" v-model="showModel.modal2Show" :title="model.title"
                                     :closable="model.closable"
                                     :maskClosable="model.maskClosable" :fullscreen="model.fullscreen"
                        ...
                        <bingo-modal ref="modal5" v-model="showModel.warnShow" :setTimeout="setTimeout" type="warning"
                                     title="提示头">
                            警告，我是提示的内容
                        </bingo-modal>
