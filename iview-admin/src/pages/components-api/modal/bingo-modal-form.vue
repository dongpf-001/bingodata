        ...
        <Card class="ivu-mt-16">
            <Form :model="model" :label-width="120">
                <FormItem label="是否显示弹窗表单">
                    <Button type="primary" @click="open">打开弹窗表单</Button>    $refs.modal.show=true;
                </FormItem>
                ...
                <FormItem label="closable">
                    <Switch v-model="model.closable" />     是否显示右上角的关闭按钮，关闭后 Esc 按键也将关闭
                </FormItem>
                <FormItem label="mask-closable">
                    <Switch v-model="model.maskClosable" />  是否允许点击遮罩层关闭
                </FormItem>
                <FormItem label="fullscreen">
                    <Switch v-model="model.fullscreen" />是否全屏显示
                </FormItem>
                <FormItem label="draggable">
                    <Switch v-model="model.draggable" />是否可以拖拽移动
                </FormItem>
